...
export const translations: Record<Lang, Dict> = {
  es: {
    ...
    "nav.revanchaTabla": "Tabla Revancha",
    "nav.reglas": "Reglas",
    "nav.dashboard": "Panel",
    ...
    "planilla.updatePrompt":
      "Hay {n} pronóstico(s) nuevos habilitados por el admin. Actualiza tu planilla y guarda.",
    "planilla.updateCta": "Actualizar y guardar planilla",
    "pin.title": "Cambiar mi PIN",
    "pin.desc": "Tu clave inicial la asigna el admin. Cámbiala por un PIN de 4 dígitos a tu gusto.",
    "pin.new": "Nuevo PIN",
    "pin.confirm": "Repite el PIN",
    "pin.submit": "Cambiar PIN",
    "pin.success": "PIN actualizado. Úsalo la próxima vez que inicies sesión.",
    "pin.err.format": "El PIN debe tener 4 dígitos.",
    "pin.err.match": "Los PIN no coinciden.",
    "pin.err.generic": "No se pudo cambiar el PIN.",
    ...
    "planilla.esp.nameLabel": "Nombre del jugador",
    "planilla.esp.namePh": "Ej: Luis Díaz",
    "planilla.esp.selLabel": "Selección",
    "planilla.esp.selPh": "Ej: Colombia",
    ...
    "admin.t.res.knockoutHint":
      "Carga el marcador oficial de cada partido. Los enfrentamientos y fechas se arman en Cronograma; aquí solo el resultado. Al guardar se recalculan los puntos.",
    ...
    "admin.t.res.recalc": "Recalcular puntos",
    "admin.t.res.dupHint": "1º y 2º repetidos",
    ...
    "admin.t.esp.colArq": "Arquero",
    "admin.t.esp.chip.header": "Goleador: {gol} aciertos · Arquero: {arq}",
    "admin.t.esp.chip.exacto": "Exacto",
    "admin.t.esp.chip.typo": "Typo",
    "admin.t.esp.chip.apellido": "Apellido",
    "admin.t.esp.chip.typoTip": '"{pick}" ≈ "{oficial}" (distancia {distancia})',
    "admin.t.esp.chip.apellidoTip": '"{pick}" coincide por apellido + equipo',
    "admin.t.esp.chip.seleccionDistintaTip": 'Equipo distinto: "{pick}" ≠ "{oficial}"',
    "admin.t.esp.chip.ambiguoTip": "Falta el equipo — no se puede confirmar",
    ...
    "admin.t.cron.scoreInResultados": "El marcador se carga en la pestaña Resultados.",
  ...
  en: {
    ...
    "nav.revanchaTabla": "Rematch Standings",
    "nav.reglas": "Rules",
    ...
    "planilla.updatePrompt":
      "There are {n} new prediction(s) enabled by the admin. Update your ballot and save.",
    "planilla.updateCta": "Update and save ballot",
    "pin.title": "Change my PIN",
    "pin.desc": "Your initial key is assigned by the admin. Change it to any 4-digit PIN you like.",
    "pin.new": "New PIN",
    "pin.confirm": "Repeat PIN",
    "pin.submit": "Change PIN",
    "pin.success": "PIN updated. Use it next time you log in.",
    "pin.err.format": "The PIN must be 4 digits.",
    "pin.err.match": "PINs don't match.",
    "pin.err.generic": "Couldn't change the PIN.",
    ...
    "planilla.noParticipant": "You haven't registered for the polla yet.",
    "planilla.goRegister": "Register",
    "planilla.pagoPendiente": "Your payment is pending admin approval.",
    "planilla.pagoRechazado": "Your payment was rejected. Please contact the admin.",
    ...
    "planilla.esp.nameLabel": "Player name",
    "planilla.esp.namePh": "E.g. Luis Díaz",
    "planilla.esp.selLabel": "National team",
    "planilla.esp.selPh": "E.g. Colombia",
    ...
    "admin.t.res.knockoutHint":
      "Enter the official score of each match. Match-ups and dates are set in Schedule; here you only enter the result. Saving recalculates points.",
    ...
    "admin.t.res.recalc": "Recalculate points",
    "admin.t.res.dupHint": "1st and 2nd repeated",
    ...
    "admin.t.esp.colArq": "Goalkeeper",
    "admin.t.esp.chip.header": "Top scorer: {gol} correct · Goalkeeper: {arq}",
    "admin.t.esp.chip.exacto": "Exact",
    "admin.t.esp.chip.typo": "Typo",
    "admin.t.esp.chip.apellido": "Surname",
    "admin.t.esp.chip.typoTip": '"{pick}" ≈ "{oficial}" (edit distance {distancia})',
    "admin.t.esp.chip.apellidoTip": '"{pick}" matches by surname + team',
    "admin.t.esp.chip.seleccionDistintaTip": 'Different team: "{pick}" ≠ "{oficial}"',
    "admin.t.esp.chip.ambiguoTip": "Missing the team — can't confirm",
    ...
    "admin.t.cron.scoreInResultados": "Scores are entered in the Results tab.",
